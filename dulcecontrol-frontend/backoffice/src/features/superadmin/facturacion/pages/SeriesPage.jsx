...
const SeriesPage = () => {
    ...
    const handleGuardar = async () => {
        try {
            ...
            if (editingSerie) {
                await facturacionApi.actualizarSerie(editingSerie.id, values);
                message.success('Serie actualizada correctamente');
            } else {
                await facturacionApi.crearSerie(values);
    ...
    const handleEliminar = async (record) => {
        try {
            setLoading(true);
            await facturacionApi.eliminarSerie(record.id);
    ...
    return (
        <div style={{ padding: 24 }}>
            <Card
                title="Gestión de Series (Superadmin)"
                extra={
            ...
            >
                <Form form={form} layout="vertical">
                    ...
                    <Form.Item
                        ...
                        label="Último Correlativo (Inicial)"
